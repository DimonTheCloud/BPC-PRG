from acc_activity import get_activity_signal
...
def test_get_activity_signal():
    assert get_activity_signal(example_acc_xyz_signal, example_magnitude_signal) == example_activity_signal
    assert get_activity_signal(file0_acc_xyz_signal, file0_magnitude_signal) == file0_activity_signal
    assert get_activity_signal(file1_acc_xyz_signal, file1_magnitude_signal) == file1_activity_signal
